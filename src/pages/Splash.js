...
//React Context is a method to pass props from parent to child component(s), by storing the props in a store(similar in Redux) and using these props from the store by child component(s) without actually passing them manually at each level of the component tree.
    ...
    const [showDialog, setShowDialog] = React.useState(false); // less secure
    const open = () => setShowDialog(true);
    const close = () => setShowDialog(false);

    const [showEVDialog, setShowEVDialog] = React.useState(false); // empty err
...
//OTHEME IS OPPOSITE THEME OF CURRENT THEME
//All thing defined in reducer.js
    ...
    return (
        <React.Fragment>
            ...
            <div id="content">
                <div class="container">
                    <div class="logo"></div>
                    <h1 class="title splash"><u>AATMANIRBHAR-SANCHAR</u></h1>
                    <h2 class="subtitle splash"><i>Simple, secure and ephemeral anonymous messaging.</i></h2>
                </div>
                        ...
                        <div class="fieldparent">
                            ...
                            <div class="buttons">
                                ...
                                {/* <div class="buttons bottom">
                                    ...
                                    <a href="https://github.com/JayJhaveri1906/Divya-Drishti" rel="noreferrer" target="_blank">
